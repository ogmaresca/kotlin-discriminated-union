...
value class TriDiscriminatedUnion<T1, T2, T3> private constructor(
	...
	override fun toPair(): Pair<T1?, T2?> {
		return map({ it to null }, { null to it }, { null to null })
	}
	...
	companion object {
		...
		inline fun <T1 : Any, T2 : Any, T3 : Any, T4> TriDiscriminatedUnion<T1?, T2?, T3?>?.fourthTypeIfAllNull(
			fourthValue: () -> T4,
		): QuadDiscriminatedUnion<T1, T2, T3, T4> {
			return if (allNull) {
				return QuadDiscriminatedUnion.fourth(fourthValue())
			} else if (this!!.isFirstType) {
				QuadDiscriminatedUnion.first(firstOrNull!!)
			} else if (isSecondType) {
				QuadDiscriminatedUnion.second(secondOrNull!!)
			} else {
				QuadDiscriminatedUnion.third(thirdOrNull!!)
			}
		}

		@JvmStatic
		@JvmName("flattenUnionOfUnionAndValuesToQuadDiscriminatedUnion")
		fun <T1, T2, T3, T4> TriDiscriminatedUnion<DiscriminatedUnion<T1, T2>, T3, T4>.flattenToQuadDiscriminatedUnion(): QuadDiscriminatedUnion<T1, T2, T3, T4> {
			return when (value) {
				is Value1<DiscriminatedUnion<T1, T2>, T3, T4> -> value.value.map(
					{ QuadDiscriminatedUnion.first(it) },
					{ QuadDiscriminatedUnion.second(it) },
				)
				is Value2<DiscriminatedUnion<T1, T2>, T3, T4> -> QuadDiscriminatedUnion.third(value.value)
				is Value3<DiscriminatedUnion<T1, T2>, T3, T4> -> QuadDiscriminatedUnion.fourth(value.value)
			}
		}

		@JvmStatic
		@JvmName("flattenUnionOfValueAndUnionAndValueToQuadDiscriminatedUnion")
		fun <T1, T2, T3, T4> TriDiscriminatedUnion<T1, DiscriminatedUnion<T2, T3>, T4>.flattenToQuadDiscriminatedUnion(): QuadDiscriminatedUnion<T1, T2, T3, T4> {
			return when (value) {
				is Value1<T1, DiscriminatedUnion<T2, T3>, T4> -> QuadDiscriminatedUnion.first(value.value)
				is Value2<T1, DiscriminatedUnion<T2, T3>, T4> -> value.value.map(
					{ QuadDiscriminatedUnion.second(it) },
					{ QuadDiscriminatedUnion.third(it) },
				)
				is Value3<T1, DiscriminatedUnion<T2, T3>, T4> -> QuadDiscriminatedUnion.fourth(value.value)
			}
		}

		@JvmStatic
		@JvmName("flattenUnionOfValuesAndUnionToQuadDiscriminatedUnion")
		fun <T1, T2, T3, T4> TriDiscriminatedUnion<T1, T2, DiscriminatedUnion<T3, T4>>.flattenToQuadDiscriminatedUnion(): QuadDiscriminatedUnion<T1, T2, T3, T4> {
			return when (value) {
				is Value1<T1, T2, DiscriminatedUnion<T3, T4>> -> QuadDiscriminatedUnion.first(value.value)
				is Value2<T1, T2, DiscriminatedUnion<T3, T4>> -> QuadDiscriminatedUnion.second(value.value)
				is Value3<T1, T2, DiscriminatedUnion<T3, T4>> -> value.value.map(
					{ QuadDiscriminatedUnion.third(it) },
					{ QuadDiscriminatedUnion.fourth(it) },
				)
			}
